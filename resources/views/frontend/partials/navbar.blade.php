        ...
        <header class="main-header header-style-two">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current dropdown"><a href="{{ route('home') }}"><span>Home</span></a>
                                            <ul>
            ...
            <div class="sticky-header">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="frontend/images/logo.png" alt=""></a></figure>
                        </div>
                        <div class="menu-area clearfix">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="frontend/images/logo-2.png" alt="" title=""></a></div>
