        ...
        <!-- feature-style-two end -->
                ...
                <section class="deals-section sec-pad text-center">
                    <div class="auto-container">
                        <div class="sec-title">
                            <h5>من نحن</h5>
                            <h2>شركة روشم للتطوير العقاري</h2>
                        </div>
                        <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                                    <h3>الرؤية</h3>
                                    <p class="grey-text text-lighten-4 mt-2"> شركة روشم للتطوير العقاري
                                        منذ تأسيسها أثرت شركة روشم للتطوير العقاري السوق العقاري بممارسة عقارية فريدة أحدثت نقلة نوعية في سوق العقار المحلي من خلال تنفيذ وإنجاز المشاريع العملاقة فحازت بذلك على رضا عملائها وثقتهم من خلال نجاحها بتنفيذ وإنجاز العديد من المشاريع والاستثمارات العقارية الكبيرة داخل المملكة  </p>
                         </div>
